...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios.get(`https://kfahrenbach.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { withCredentials: true }
    ).then(response => {
      ...
      console.log('getBlockItems error', error);
    })
  }
        ...
        {this.props.loggedInStatus === "LOGGED_IN" ? (
          <div className="new-blog-link">
            <a onClick={this.handleNewBlogClick}>
              Open Modal!
              {/* <FontAwessomeIcon icon="plus-circle" /> */}
            </a>
          </div>
        ) : null }
